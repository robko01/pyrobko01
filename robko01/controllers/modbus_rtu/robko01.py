...
def _get_pymodbus():
    ...
    if _pymodbus is None:
        try:
            ...
            raise ImportError("pymodbus is required for Modbus RTU: pip install pymodbus") from exc
        _pymodbus = _p
    return _pymodbus
...
class Robko01(Robko01Base):
    """Modbus RTU controller implementation (pymodbus)."""
...
#region Constructor
    ...
    def __init__(self, **kwargs):
        ...
        if not port:
            raise ValueError("Modbus RTU requires 'port'.")
        ...
        ModbusSerialClient = pymodbus.client.ModbusSerialClient
...
#region Public Methods
    ...
    def is_connected(self) -> bool:
        return bool(getattr(self.__client, "connected", False))
    ...
    def clear(self):
        self.__logger.warning("Clear is not supported by Modbus RTU. No action taken.")
        return None
