...
#region Public Methods
    ...
    def move_speed(self, current_point):
        ...
        str_address = str(self.__address).zfill(2)
        str_register = str(reg_index).zfill(2)
        str_phase_mode = str(phase_mode).zfill(4)
        str_phase_time = str(phase_time).zfill(4)
        msg = ":{}{}{}{}{}{}\r\n"\
            .format(str_address, str_register, motor_index,\
                    motor_direction, str_phase_mode, str_phase_time)
